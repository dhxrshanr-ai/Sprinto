      ...
      >
        <div className="flex justify-center flex-col items-center">
          ...
          <p className="mt-2 text-center text-[13px] text-[var(--text-muted)]">
            ...
            Sign in or <Link to="/register" className="font-medium text-[var(--accent)] hover:text-[var(--accent-hover)] transition-colors">create an account</Link>
          </p>
        </div>
      </motion.div>
        ...
        <div className="glass-panel py-8 px-4 shadow sm:rounded-xl sm:px-10 relative overflow-hidden backdrop-blur-xl border border-[var(--border-subtle)]">
          <form className="space-y-5 relative z-10" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center justify-between mt-1 pt-1 mb-2">
                <div className="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 rounded border-[var(--border-strong)] bg-[var(--bg-base)] text-indigo-600 focus:ring-indigo-600" />
                  <label htmlFor="remember-me" className="ml-2 block text-xs text-[var(--text-muted)]">Remember me</label>
                </div>
                <div className="text-xs">
                  <a href="#" className="font-medium text-[var(--accent)] hover:text-[var(--accent-hover)]">Forgot password?</a>
                </div>
              </div>
            </div>
          ...
          <div className="mt-6 relative z-10">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-[var(--bg-surface)] px-2 text-[var(--text-muted)] text-xs uppercase tracking-wide">Or continue with</span>
              </div>
            </div>
